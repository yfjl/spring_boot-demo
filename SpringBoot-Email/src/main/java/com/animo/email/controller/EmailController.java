...
public class EmailController {
    ...
    public ServerResponse sendSimpleMail(){
        try {
            mailService.sendSimpleMail("1758915542@qq.com","SpringBoot Email","这是一封普通的SpringBoot测试邮件");
        }catch (Exception ex){
            ex.printStackTrace();
    ...
    public ServerResponse htmlEmail(){
        try {
            mailService.sendHtmlMail("1758915542@qq.com","IJPay让支付触手可及","<body style=\"text-align: center;margin-left: auto;margin-right: auto;\">\n"
    ...
    public ServerResponse attachmentsMail(){
        try {
            String filePath = "/Users/yangfeng/a.js";
            mailService.sendAttachmentsMail("1758915542@qq.com", "这是一封带附件的邮件", "邮件中有附件，请注意查收！", filePath);
        }catch (Exception ex){
            ex.printStackTrace();
            return ServerResponse.createByError(-1,"邮件发送失败!!");
        }
    ...
    public ServerResponse resourceMail(){
        try {
            ...
            mailService.sendResourceMail("1758915542@qq.com", "这邮件中含有图片", content, imgPath, rscId);
    ...
    public ServerResponse templateMail(){
        try {
            ...
            mailService.sendHtmlMail("1758915542@qq.com", "这是模板邮件", emailContent);
        }catch (Exception ex){
            ex.printStackTrace();
            return ServerResponse.createByError(-1,"邮件发送失败!!");
        }
